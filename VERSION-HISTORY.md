...
| | **coming soon:** Default write-mode for DAT & LOG files is changed to "w" (replace). Append requires new optional `-a y` parameter.
| | **coming soon:** GPU-mode performance improvements.
